...
private:
    ...
    //ndt 중첩 Pointcloud 관련 변수

    rclcpp::Publisher < sensor_msgs::msg::PointCloud2> ::SharedPtr ndt_accumulate_cloud_pub_; 
    std::queue<sensor_msgs::msg::PointCloud2> ndt_accumulate_cloud_queue_;
    ...
    // ndt 중첩 Pointcloud 관련 변수
    int ndt_accumulate_stack_ {1};
    std::string ndt_accumulate_topic_name_;
